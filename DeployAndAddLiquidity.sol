...
contract DeployAndAddLiquidity {
    event CreatedAddres(address indexed);

    ModelERC20 public deployedContract;
    ...
    constructor(
        ...
        deployedContract = new ModelERC20(
            _name,
            _symbol,
            _totalSupply,
            _supplyToLiquidity,
            ...
            _gasRestrictionsBlocks,
            _bools.renounce,
            _bools.tradeEnabled
        );

        deployedContract.approve(_routerAddress, _supplyToLiquidity);
